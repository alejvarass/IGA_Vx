...
Public AnhídricoCarbonico As Double
Public Sulfhídrico1 As Double
Public Sulfhídrico2 As Double
Public Sulfhídrico3 As Double
Public Sulfhídrico4 As Double
Public Sulfhídrico5 As Double
...
Select Case Unindice   ' Evalúa el indice.
    ...
    Case 100
        AnhídricoCarbonico = Val(Unstr)
    Case 101
        Sulfhídrico1 = Val(Unstr)
    Case 102
